...
Disclaimer: if you plan on building something and there are real consequences if it were to fail, please don't use this. Use professional, reputable software.
